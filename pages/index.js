import { TextInput, Button, Group, Box, Head} from "@mantine/core";
    ...
    <div className="container mx-auto my-6 max-w-2xl">
      ...
      <body>
        <div className="p-5 min-h-screen bg-gray-50">
          <h1 className="text-2xl text-center font-bold text-gray-800 py-2">SHA Ambassador Heart Point Tracker</h1>
          <h3 className="text-sm text-center text-gray-600 py-.5">questions? please contact our ambassador secretary</h3>
          <Box mx="auto">
          ...
          {/* <aside class="p-4 my-8 bg-gray-100 border-gray-400 rounded-lg shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">              
